...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "GROUP5"."CART_TNO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 9 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MEMBER_MID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GROUP5"."MEMBER_MID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ORDER_OID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GROUP5"."ORDER_OID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 9 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CART
--------------------------------------------------------

  CREATE TABLE "GROUP5"."CART" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "GROUP5"."ORDER_LIST" 
   (	"OID" NUMBER(38,0), 
	"MID" NUMBER(38,0), 
	"ORDERTIME" DATE, 
	"PRICE" NUMBER(38,0), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
REM INSERTING into GROUP5.CART
SET DEFINE OFF;
REM INSERTING into GROUP5.MEMBER
SET DEFINE OFF;
Insert into GROUP5.MEMBER (MID,NAME,ACCOUNT,PASSWORD,IDENTITY) values ('1','王大明','mingwang','test','user');
Insert into GROUP5.MEMBER (MID,NAME,ACCOUNT,PASSWORD,IDENTITY) values ('2','孫小美','may','test','user');
Insert into GROUP5.MEMBER (MID,NAME,ACCOUNT,PASSWORD,IDENTITY) values ('3','林大偉','weiLin','test','user');
Insert into GROUP5.MEMBER (MID,NAME,ACCOUNT,PASSWORD,IDENTITY) values ('4','陳美環','maychang','test','user');
REM INSERTING into GROUP5.ORDER_LIST
SET DEFINE OFF;
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (1,4,to_date('04-7月 -21','DD-MON-RR'),4350,1);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (2,1,to_date('26-4月 -21','DD-MON-RR'),1500,2);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (3,2,to_date('18-8月 -21','DD-MON-RR'),1300,3);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (4,3,to_date('31-5月 -21','DD-MON-RR'),800,4);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (5,2,to_date('09-12月-21','DD-MON-RR'),700,5);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (6,2,to_date('05-9月 -21','DD-MON-RR'),1100,6);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (7,2,to_date('16-7月 -21','DD-MON-RR'),1200,7);
Insert into GROUP5.ORDER_LIST (OID,MID,ORDERTIME,PRICE,TNO) values (8,4,to_date('27-2月 -21','DD-MON-RR'),100,8);
REM INSERTING into GROUP5.PRODUCT
SET DEFINE OFF;
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('u58046','商品1234',888,'BOOK','胡錦濤曾講過，對外開放的國策不能變。但中國人也要避免在未來的中國經濟中成為跑龍套的。要做到這一點，就需要國人支持本土企業，提高自主發展能力。韓國人“”這句話很好嘛，這種精神值得中國人學習。這段話讓我所有的疑惑頓時豁然開朗。每個人的一生中，幾乎可說碰到商品123這件事，是必然會發生的。如果此時我們選擇忽略商品123，那後果可想而知。\n 我想，把商品123的意義想清楚，對各位來說並不是一件壞事。丁尼生講過，科學的進展是十分緩慢的，需要爬行才能從一點到達另一點。這段話非常有意思。商品123因何而發生？世界需要改革，需要對商品123有新的認知。我們都有個共識，若問題很困難，那就勢必不好解決。商品123勢必能夠左右未來。比豐曾說過，天才不是別的，而是辛勞和勤奮。這段話讓我所有的疑惑頓時豁然開朗。每個人都不得不面對這些問題。在面對這種問題時，務必詳細考慮商品123的各種可能。說到商品123，你會想到什麼呢？');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('v00111','英雄',400,'DVD','● 《神話》和《英雄》是英國喜劇大師、有聲書領域的大師人物“油炸叔”斯蒂芬·弗萊為成人重新講述的希臘神話。在這套書中，斯蒂芬·弗萊以作為演員和作家的雙重身份，重新梳理了希臘神話的脈絡，並用戲劇線索將它們串聯起來，徹底摒除了希臘神話的生硬感和學術感，為希臘神話賦予了更加豐富的情節、更加鮮明的個性和具有吸引力的電影質感。\n ● 如果說《神話》是由希臘眾神組成的一個“復仇者聯盟”，那《英雄》就是為希臘神話中的英雄單獨拍攝的獨立英雄電影。在本書中，我們可以跟隨弗萊的講述看到：\n 唯yi得到了善終的英雄珀爾修斯怎樣斬獲美杜莎的頭顱；\n 一心當鹹魚的赫拉克勒斯如何在赫拉的詛咒下走上英雄之路；\n 歷盡艱辛取得金羊毛的伊阿宋，成也女人，敗也女人；\n 受到伊阿宋被判的美狄亞，親自殺死自己的孩子和伊阿宋的新歡；\n 這些戲劇性的、有趣的、悲劇性的和永恆的故事都可以在本書中看到。可以說，希臘神話是一個巨大的寶庫，而斯蒂芬·弗萊就是一位幽默的寶庫引路人，帶領我們去看它究竟有多迷人、多有趣。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('d11222','任賢齊專輯三',300,'CD','1990年由新格唱片出版的「再問一次」，是任賢齊歌唱生涯的首張個人專輯，雖然質樸生澀，卻是青春時期夢想揚帆的起點。由於任賢齊大一就開始組Band，20歲時更展開校園DJ的生涯，製作人因此針對他陽光明亮、活潑隨和而又熱愛音樂的特質，挑選了不少輕快甚至富有節奏感的歌曲，像是〈就讓一切自由〉、〈奔向午後〉、〈年輕的心〉以及重搖滾曲風的〈我想預約所有的愛〉均屬這類型的歌曲。青澀的校園歲月，除了編織的夢想與兄弟的情誼外，愛情更在年輕生命中占有重要的一席之地，主打歌〈再問一次〉以及〈別再回頭〉、〈走一段想妳的路〉和〈妳的心我知道〉，在在都展現了小齊彼時單純而又直覺的愛情觀與憧憬。');
...
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b30772','五月天專輯：知足',450,'CD','五月天6首新歌加6年精華傑作即將強勢襲台 首波主打【戀愛ing】MV搶到墾丁難得陽光 決定該是時候讓大家靜下來，好好檢查自己一眨眼的六年與復出後毫無喘息空間的兩年，要為自己與歌迷作一次總整理，找到五個人下一個五年新的出發點。讓一切歸零，重新找回與音樂戀愛的心情，要回歸第一張專輯發行的夏天發片。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('d03333','5566專輯',450,'CD','狂賀！發片首日即登各大排行榜冠軍！亞洲天團5566首張精選作品，冠軍氣勢，所向披靡！\n 慶功紀念版限量發行，超值加贈：\n ●2首新歌（C’est si bon+It’s Our Party Time)及12首精選完整MV\n ●5566歷年冠軍專輯封面圖鑑海報（贈品內附在CD包裝內）\n 汗水、淚水、體力、耐力，成就九百八十二天的輝煌冠軍紀錄。亞洲天團5566 首張超值精選經典作品，3首新歌+12首精選。力與美、抒情與動感、快樂與憂傷全部收藏。感謝你們一路相伴5566放每位歌迷在心裡最重要的地方。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b30773','五月天專輯：人生無限公司',650,'CD','[ 人生無限公司 ] Life Live 全球巡演55城市122場， 本碟完整收錄巡演音樂全紀實。 3CD 36首歌，除了 [ 完整收錄篇 ] 的演唱會曲目外，更有各地分公司群星主管，齊來出差跨刀的 [ 好友加班篇 ]。 蕭敬騰. 田馥甄. 蔡依林. 陳綺貞. 李榮浩. 羅志祥. 張國璽. 吳宗憲. 歐陽靖. GLAY TERU. 十位巨星與420萬位社員熱情合唱。 這些滿載紀念價值的作品，收錄在 Life Live 裡，成為無限人生裡，最動人的自傳篇章。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b20776','蔡依林專輯：呸Play',600,'CD','首張同時登上美國《時代雜誌》官網、加拿大《CMB》音樂雜誌、西班牙《GQ》雜誌網站 澳洲 巴西 法國 荷蘭, 克羅埃西亞等國際傳媒推薦介紹 2014全球音樂話題討論度最高華語年度流行熱門專輯! 絕世好呸 話題不墜 國際級豪華旗艦版 CD+DVD 超值收錄籌備8個月耗資5千萬[玩劇女伶]全主打9支MV音樂錄影帶DVD+ 穿越古今橫跨中西50組百變造型 [2015玩美人生寫真週曆]');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b20778','蔡依林專輯：花蝴蝶',450,'CD','史上最豪華平裝專輯，CD+DVD誠意巨獻 金曲台前幕後得主 三頭六臂聯手打造 一年ㄧ張全力付出  10首新/型音樂品種 以花蝴蝶JOLIN為創作謬思  華語最Hit創/製作人大集合   創意繽紛花開泉湧！ ★誠意巨獻Bonus DVD 『DANCE with JOLIN』 JOLIN遠赴美國東西兩岸進行魔鬼特訓，二大最HIT名師Jonte、Bobby Newberry親自教學，激盪耀眼火花，完整舞蹈版MV首次絕密珍藏！');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('F95191','啦啦啦',100,'DVD','讓一首又一首超有創意的兒歌，陪伴孩子在音樂中學習，於遊戲中成長。\n 手部的動作與大腦的發育有著重要的聯繫，當大腦得到豐富的鍛鍊，孩子自然會聰明、機靈，科學實驗顯示，手指的活動對孩子語言、視覺、聽覺、觸覺的發展都有很大的助益。\n 此外，透過反覆遊戲的練習，孩子會漸漸懂得「等待」與「掌握時機」，而每首手指謠的歌詞與動作都有密切配合，孩子會在念唱中激發出想像力與創造力。當父母和孩子一同念唱手指謠時，透過語言、眼神與肢體的接觸，還能培養出絕佳的親子默契。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('W42957','真愛一生',300,'BOOK','每個婚姻都需要經營與餵養。對於夫妻而言，將時間及精力投資於此，是最有價值的。有上百萬人能夠證明，沒有甚麼比建立婚姻更能應用神話語的原則。\n 本書是今日最佳的婚姻宣言，其中以聖經為基礎的觀點，是每一位已訂婚、或已進入婚姻的男女最佳的選擇，它能強化每一對夫妻之間的關係。從本書中尋找智慧，它能使你在婚姻中獲致持續的成功。');
...
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('v10888','哈利波特：混血王子的背叛',500,'CD','如果要讓哈利波特選出自己在霍格華茲中最討厭的一門課，「魔藥學」絕對名列前茅。拋開長年以來與石內卜教授的恩怨情仇，他的成績也始終在及格邊緣掙扎。所以就算升上了六年級，換了新的魔藥學教授，哈利也不期待自己能獲得多大進步。直到他偶然得到一份筆記，竟奇蹟地扭轉一切！透過更高效的魔藥製作方法、課本沒教的神奇咒語，這份署名「混血王子」的筆記不但讓他的表現超越妙麗，更讓他對魔藥學有了全新的認識。\n 儘管如此，探究「混血王子」的真實身分卻不是哈利的當務之急，有更迫切的使命正等待著他。佛地魔在失去力量之前，曾經把自己的靈魂分成七份，其中六份被藏入了可以儲存魔法的「分靈體」之中。如今哈利必須與鄧不利多攜手合作，將散落各處的分靈體盡數摧毀，才能徹底殺死黑魔王。\n 但在計畫成功之前，時間恐怕不站在哈利這邊。魔法部高層面臨權力更迭，潛伏在暗處的食死人們蠢蠢欲動，就連霍格華茲也不再安全了。秘密與猜忌，謊言與背叛，一場前所未有的風暴即將吞噬整個魔法世界。哈利必須要謹慎選擇自己的盟友，因為他身邊，早已有人被烙上了屬於佛地魔的「黑魔標記」……');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b30999','資料庫理論與實務',500,'BOOK','本書涵蓋了實務上常用的資料庫理論，為有志升學者必備教本。\n 因應雲端科技的發展，強化「雲端運算與資料庫」一章，除了描述雲端環境下資料的型態和結構外，對於近年來愈來愈普遍的NoSQL資料庫也做了介紹，尤其針對目前最流行的NoSQL資料庫MongoDB做了相當具體的說明。\n 以同一個範例（網路書店的線上購物系統）貫穿全書來說明資料庫的重要觀念，同時提供多個範例程式下載及系統支援實務練習，本版更新「Web程式語言和資料庫應用」一章裡的程式範例以反映最新的程式版本，本書為有志精研資料庫者必讀書籍。\n 提供「中山網路書店」範例系統，讓讀者可以具體瞭解每一個應用系統後面資料庫的變化情形，全書有200 餘張圖表，讓讀者更容易理解相關概念，並有豐富的練習題和習題，其中絕大部分是演算題，有助強化讀者在資料庫設計的應用能力。\n 本書專屬網站有課程投影片、網路書店範例系統、SQL語法練習、練習題和習題解答、範例程式下載、資料庫網路資源、討論版等，本版更提供每章的影音檔和前八章每章的課後測驗題，網站裡也提供練習題解答、測驗題解答和部分習題解答，是教師授與學生研習的最佳後盾。');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b20777','蔡依林專輯二',350,'CD','見怪不怪 美不勝收\n 打破世俗標準的審美觀  包容大千世界的惡與善\n 亞洲流行天后 蔡依林 JOLIN最新專輯 UGLY BEAUTY\n 11首心靈探索自問自答  最誠實的私密音樂日記');
Insert into GROUP5.PRODUCT (PID,PNAME,PRICE,CATEGORY,PDESC) values ('b51111','電子商務理論與實務',700,'BOOK','各篇章的主題都很符合目前智慧電子商務的環境，研究也都有其深厚的學術理論與價值，學術性的嚴謹內容將來可能都會在相關的學術期刊發展，但是本書嘗試先以深入淺出的方式，讓非專業的讀者也能夠瞭解研究的發現。');
REM INSERTING into GROUP5.RECORD
SET DEFINE OFF;
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (1,'b51111',3,700,2100);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (1,'d03333',5,450,2250);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (2,'W42957',3,300,900);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (2,'b10234',1,600,600);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (3,'d11222',3,300,900);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (3,'v00111',1,400,400);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (4,'N41023',2,400,800);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (5,'b20777',2,350,700);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (6,'b40555',2,550,1100);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (7,'v00111',3,400,1200);
Insert into GROUP5.RECORD (TNO,PID,AMOUNT,SALEPRICE,TOTAL) values (8,'F95191',1,100,100);
--------------------------------------------------------
--  DDL for Trigger MEMBER_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "GROUP5"."MEMBER_TRG" 
...
/
ALTER TRIGGER "GROUP5"."MEMBER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ORDER_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "GROUP5"."ORDER_TRG" 
...
/
ALTER TRIGGER "GROUP5"."ORDER_TRG" ENABLE;
